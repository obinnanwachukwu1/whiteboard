...
export function SettingsModal({ isOpen, onClose }: Props) {
  ...
  // AI Status Polling
  React.useEffect(() => {
    if (!window.embedding || !embeddingsEnabled || !isOpen) return
  ...
  return (
    <Modal open={isOpen} onClose={onClose} title="Settings" width="max-w-3xl">
      <div className="space-y-6 max-h-[75vh] overflow-y-auto pr-1">
        ...
        <section className="rounded-card ring-1 ring-gray-200 dark:ring-neutral-800 p-4 bg-white/60 dark:bg-neutral-900/60 backdrop-blur shadow-card">
          ...
          <div className="grid gap-4 w-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 w-full mt-4 border-t border-gray-100 dark:border-neutral-800 pt-4">
              <div className="text-sm">
        ...
        <section className="rounded-card ring-1 ring-gray-200 dark:ring-neutral-800 p-4 bg-white/60 dark:bg-neutral-900/60 backdrop-blur shadow-card">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 w-full mt-4">
            <div className="text-sm">
