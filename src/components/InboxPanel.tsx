...
import { X, Plus, Send, Star, Archive, Trash2, Mail, ArrowLeft, Loader2 } from 'lucide-react'
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <span className={`text-sm truncate ${conv.workflow_state === 'unread' ? 'font-semibold text-slate-900 dark:text-white' : 'text-slate-700 dark:text-slate-200'}`}>
              ...
              <div className={`text-sm truncate ${conv.workflow_state === 'unread' ? 'font-medium text-slate-700 dark:text-slate-300' : 'text-slate-500 dark:text-neutral-400'}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`p-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-neutral-800 transition-colors ${conversation.starred ? 'text-yellow-500' : 'text-slate-400'}`}
            ...
            <button
              ...
              className="p-1.5 rounded-md text-slate-400 hover:bg-slate-100 dark:hover:bg-neutral-800 hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
              title="Archive"
            >
            ...
            <button
              ...
              className="p-1.5 rounded-md text-slate-400 hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-600 transition-colors"
              title="Delete"
            >
...
export const InboxPanel: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-black/20 dark:bg-black/40 z-[200] transition-opacity"
        onClick={onClose}
        aria-hidden
      />
