...
import Se from "util";
import W, { Readable as Lt } from "stream";
import _i from "path";
import sn from "http";
...
const Ai = J("ArrayBuffer");
function Dt(e) {
  let a;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? a = ArrayBuffer.isView(e) : a = e && e.buffer && Ai(e.buffer), a;
}
const Mt = pa("string"), I = pa("function"), ji = pa("number"), Ue = (e) => e !== null && typeof e == "object", Ht = (e) => e === !0 || e === !1, Je = (e) => {
  if (ca(e) !== "object")
    return !1;
  const a = rn(e);
...
}, Wt = J("Date"), Vt = J("File"), Jt = J("Blob"), Kt = J("FileList"), Xt = (e) => Ue(e) && I(e.pipe), Yt = (e) => {
  let a;
...
}, Qt = J("URLSearchParams"), [Zt, es, as, ns] = ["ReadableStream", "Request", "Response", "Headers"].map(J), is = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const ts = (e, a, n, { allOwnKeys: i } = {}) => (Le(a, (t, s) => {
  ...
  for (; (n = e.exec(a)) !== null; )
    i.push(n);
  return i;
}, ms = J("HTMLFormElement"), fs = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, i, t) {
    return i.toUpperCase() + t;
  }
), Tn = (({ hasOwnProperty: e }) => (a, n) => e.call(a, n))(Object.prototype), xs = J("RegExp"), Fi = (e, a) => {
...
const ws = (e) => {
  ...
  return n(e, 0);
}, ks = J("AsyncFunction"), _s = (e) => e && (Ue(e) || I(e)) && I(e.then) && I(e.catch), Pi = ((e, a) => e ? setImmediate : a ? ((n, i) => (ce.addEventListener("message", ({ source: t, data: s }) => {
...
var Ii = Us;
function Us(e) {
  Object.keys(e.jobs).forEach(Ls.bind(e)), e.jobs = {};
}
function Ls(e) {
...
var Wi = la.exports, Zs = Wi, eo = ao;
function ao(e, a, n) {
  return Zs(e, a, null, n);
}
var no = {
  parallel: Vs,
  serial: eo,
...
var Uo = Function.prototype.call, Lo = Object.prototype.hasOwnProperty, Bo = ua, ln = Bo.call(Uo, Lo), S, zo = Vi, No = io, $o = to, Io = so, Do = oo, ke = ro, we = cn, Mo = co, Ho = po, Go = lo, Wo = uo, Vo = mo, Jo = fo, Ko = xo, Xo = bo, Zi = Function, Oa = function(e) {
  try {
...
}() : Fa, he = wo()(), q = qo(), Zo = Yi(), er = Xi(), et = Qi(), Be = pn(), be = {}, ar = typeof Uint8Array > "u" || !q ? S : q(Uint8Array), le = {
  __proto__: null,
...
var ir = function e(a) {
...
}, ze = ua, Ze = ln, tr = ze.call(Be, Array.prototype.concat), sr = ze.call(et, Array.prototype.splice), Jn = ze.call(Be, String.prototype.replace), ea = ze.call(Be, String.prototype.slice), or = ze.call(Be, RegExp.prototype.exec), rr = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, cr = /\\(\\)?/g, pr = function(a) {
  ...
  var i = a, t;
  if (Ze(Vn, i) && (t = Vn[i], i = "%" + t[0] + "%"), Ze(le, i)) {
    var s = le[i];
  ...
  for (var r = 1, l = !0; r < i.length; r += 1) {
    ...
    if ((m === "constructor" || !l) && (p = !0), t += "." + m, o = "%" + t + "%", Ze(le, o))
      c = le[o];
    else if (c != null) {
      if (!(m in c)) {
        if (!n)
...
}, un = js, gr = Se, qa = _i, yr = sn, wr = on, kr = oa.parse, _r = Bt, Sr = W.Stream, Er = Si, Ua = Ni, Rr = no, Cr = hr, ie = ln, Ja = br;
function E(e) {
...
E.prototype._getContentType = function(e, a) {
  var n = a.contentType;
  return !n && e && e.name && (n = Ua.lookup(e.name)), !n && e && e.path && (n = Ua.lookup(e.path)), !n && e && e.readable && ie(e, "httpVersion") && (n = e.headers["content-type"]), !n && (a.filepath || a.filename) && (n = Ua.lookup(a.filepath || a.filename)), !n && e && typeof e == "object" && (n = E.DEFAULT_CONTENT_TYPE), n;
};
...
}, Fr = oa.URLSearchParams, La = "abcdefghijklmnopqrstuvwxyz", ei = "0123456789", st = {
  DIGIT: ei,
  ALPHA: La,
  ALPHA_DIGIT: La + La.toUpperCase() + ei
...
}, fn = typeof window < "u" && typeof document < "u", Xa = typeof navigator == "object" && navigator || void 0, Ur = fn && (!Xa || ["ReactNative", "NativeScript", "NS"].indexOf(Xa.product) < 0), Lr = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
var ct = {}, Yr = oa.parse, Qr = {
  ...
  ws: 80,
  wss: 443
}, Zr = String.prototype.endsWith || function(e) {
...
function ec(e) {
  ...
  if (typeof i != "string" || !i || typeof n != "string" || (n = n.split(":", 1)[0], i = i.replace(/:\d*$/, ""), t = parseInt(t) || Qr[n] || 0, !ac(i, t)))
    return "";
...
function ac(e, a) {
  ...
  return n ? n === "*" ? !1 : n.split(/[,\s]/).every(function(i) {
    ...
    return o && o !== a ? !0 : /^[.*]/.test(s) ? (s.charAt(0) === "*" && (s = s.slice(1)), !Zr.call(e, s)) : e !== s;
  }) : !0;
}
function ye(e) {
...
D.prototype._processResponse = function(e) {
  ...
  if (lt("redirecting to", r.href), this._isRedirect = !0, Za(r, this._options), (r.protocol !== c.protocol && r.protocol !== "https:" || r.host !== p && !hc(r.host, p)) && Ma(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), fe(t)) {
    var l = {
      headers: e.headers,
      statusCode: a
    }, m = {
...
function ut(e) {
  ...
  return Object.keys(e).forEach(function(i) {
    ...
    function c(u, r, l) {
      return gc(u) ? u = Za(u) : ue(u) ? u = Za(kn(u)) : (l = r, r = mt(u), u = { protocol: t }), fe(r) && (l = r, r = null), r = Object.assign({
...
vn.exports.wrap = ut;
var yc = vn.exports;
const wc = /* @__PURE__ */ Li(yc), aa = "1.11.0";
function ft(e) {
...
const Ac = (e, a, n) => {
  ...
  return Number.isFinite(p) && (r["Content-Length"] = p), a && a(r), Lt.from(async function* () {
    for (const l of u)
...
}, di = d.isFunction(ne.createBrotliDecompress), { http: qc, https: Uc } = wc, Lc = /https:?/, mi = O.protocols.map((e) => e + ":"), fi = (e, [a, n]) => (e.on("end", n).on("error", n), a);
function Bc(e, a) {
...
const zc = typeof process < "u" && d.kindOf(process) === "process", Nc = (e) => new Promise((a, n) => {
  ...
  return Nc(async function(i, t, s) {
    ...
    if (c) {
      ...
      c = (k, B, oe) => {
        _(k, B, (U, ee, ba) => {
          if (U)
            return oe(U);
          const Y = d.isArray(ee) ? ee.map((G) => xi(G)) : [xi(ee, ba)];
    ...
    d.isArray(V) ? (X = V[0], ve = V[1]) : X = ve = V, o && (M || X) && (d.isStream(o) || (o = W.Readable.from(o, { objectMode: !1 })), o = W.pipeline([o, new pi({
    ...
    if ($.agent = ha ? a.httpsAgent : a.httpAgent, a.transport ? De = a.transport : a.maxRedirects === 0 ? De = ha ? on : sn : (a.maxRedirects && ($.maxRedirects = a.maxRedirects), a.beforeRedirect && ($.beforeRedirects.config = a.beforeRedirect), De = ha ? Uc : qc), a.maxBodyLength > -1 ? $.maxBodyLength = a.maxBodyLength : $.maxBodyLength = 1 / 0, a.insecureHTTPParser && ($.insecureHTTPParser = a.insecureHTTPParser), f = De.request($, function(k) {
      ...
      U = B.length > 1 ? W.pipeline(B, d.noop) : B[0];
      const ba = W.finished(U, () => {
        ba(), v();
      }), Y = {
        status: k.statusCode,
      ...
      if (u === "stream")
        ...
        U.on("data", function(N) {
          G.push(N), jn += N.length, a.maxContentLength > -1 && jn > a.maxContentLength && (x = !0, U.destroy(), t(new g(
          ...
          f.destroyed || t(g.from(N, null, a, ee));
        }), U.on("end", function() {
          try {
            let N = G.length === 1 ? G[0] : Buffer.concat(G);
            u !== "arraybuffer" && (N = N.toString(r), (!r || r === "utf8") && (N = d.stripBOM(N))), Y.data = N;
          } catch (N) {
            return t(g.from(N, null, a, Y.request, Y));
          }
          ge(i, t, Y);
        });
      }
      h.once("abort", (G) => {
        U.destroyed || (U.emit("error", G), U.destroy());
      });
    }), h.once("abort", (_) => {
      t(_), f.destroy(_);
...
const Qc = async (e) => {
  ...
  let v;
  try {
    if (p && Yc && n !== "get" && n !== "head" && (v = await Zc(r, i)) !== 0) {
      let R = new Request(a, {
        method: "POST",
        body: i,
        duplex: "half"
...
function Rn() {
  try {
    const e = _t();
    return Z.existsSync(e) ? JSON.parse(Z.readFileSync(e, "utf-8")) || {} : {};
  } catch {
    return {};
  }
}
function St(e) {
  try {
    const a = _t();
    Z.mkdirSync(H.dirname(a), { recursive: !0 }), Z.writeFileSync(a, JSON.stringify(e, null, 2));
  } catch {
  }
}
...
function va() {
  try {
    const e = Et();
    if (!Z.existsSync(e)) return { ...Wa };
    const a = Z.readFileSync(e, "utf-8"), n = JSON.parse(a);
    return { ...Wa, ...n };
  } catch {
    return { ...Wa };
  }
...
function Rt(e) {
  const n = { ...va(), ...e }, i = Et();
  try {
    Z.mkdirSync(H.dirname(i), { recursive: !0 }), Z.writeFileSync(i, JSON.stringify(n, null, 2));
  } catch {
  }
  return n;
}
const Ct = H.dirname(Ut(import.meta.url));
...
function jt() {
  ...
  }), tn ? ae.loadURL(tn) : ae.loadFile(H.join(Cn, "index.html"), { hash: "/dashboard" });
}
me.on("window-all-closed", () => {
  process.platform !== "darwin" && (me.quit(), ae = null);
});
me.on("activate", () => {
